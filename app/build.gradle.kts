...
android {
    namespace = "com.simplecast"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.simplecast"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Embedded HTTP Server for Local Gallery Streaming
    implementation("org.nanohttpd:nanohttpd:2.3.1")

    // MediaRouter for Cast / Miracast System Display discovery
